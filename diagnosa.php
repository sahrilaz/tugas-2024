...
<html lang="en">
<head>
  <title>Universitas Indraprasta Tech</title>
  <meta charset="utf-8">
...
<footer class="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
    <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://Universitas Indraprasta Tech.my.id" class="hover:underline">Universitas Indraprasta Tech™</a>. All Rights Reserved.
    </span>
